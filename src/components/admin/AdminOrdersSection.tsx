		...
		<section className="space-y-6">
			...
			<div className="rounded-xl border bg-card md:rounded-2xl">
				<div className="flex items-center justify-between gap-3 border-b px-4 py-3 md:px-5 md:py-4">
					<div className="text-base font-extrabold tracking-tight md:text-lg">Order List</div>
					<div className="text-xs text-ink-muted tabular-nums md:text-sm">{filtered.length} orders</div>
				</div>
