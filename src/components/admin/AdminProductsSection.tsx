    ...
    <section className="space-y-6">
      ...
      <div className="rounded-2xl border bg-card">
        <div className="flex items-center justify-between gap-3 border-b px-5 py-4">
          <div className="text-lg font-extrabold tracking-tight">Product List</div>
          <div className="text-sm text-ink-muted tabular-nums">{filtered.length} products</div>
        </div>
                  ...
                  <TableRow key={p.id} className="hover:bg-accent/30">
                    ...
                    <TableCell className="text-right">
                      <div className="inline-flex items-center justify-end gap-2">
                        <Button variant="outline" size="sm" className="h-10 px-4" onClick={() => openEdit(p)}>
                          <Pencil />
                          Edit
                        </Button>
                        <Button
